...
internal sealed partial class MainForm : Form
{
    ...
    public void RefreshView()
    {
        ...
        Text = T("AppName");
        _heroTitleLabel.Text = T("HeroTitle");
        _heroSubtitleLabel.Text = T("HeroSubtitle");
        _languageLabel.Text = T("LanguageLabel");
        ...
        _statusTitle.Text = running ? T("OverviewStatusActive") : T("OverviewStatusPaused");
        _statusBody.Text = _context.StatusText;
        _anchorValue.Text = string.Format(T("OverviewAnchorValue"), config.LastPrimaryMousePosition.X, config.LastPrimaryMousePosition.Y);
        _supportTitleLabel.Text = T("OverviewSupportTitle");
        _gratitudeLabel.Text = T("OverviewGratitudeMessage");
        _supportEmailLink.Text = T("OverviewSupportEmail");
        _helpButton.Text = T("HelpButton");
        _coffeeButton.Text = T("CoffeeButton");
        _logStatusLabel.Text = _context.LoggingEnabled ? T("DiagnosticsLoggingEnabled") : T("DiagnosticsLoggingDisabled");
        _logStatusLabel.ForeColor = _context.LoggingEnabled ? Color.FromArgb(28, 120, 68) : Color.FromArgb(120, 126, 137);
        _overviewTab.Text = T("TabOverview");
        _displaysTab.Text = T("TabDisplays");
        _behaviorTab.Text = T("TabBehavior");
        _diagnosticsTab.Text = T("TabDiagnostics");
    ...
    {
        Text = "MouseTool";
        _heroTitleLabel.Text = "MouseTool Control Center";
        _heroSubtitleLabel.Text = "Design-time preview for the MouseTool dashboard.";
        _languageLabel.Text = "Language";
        _statusBadge.Text = "ACTIVE";
        _statusBadge.BackColor = Color.FromArgb(223, 245, 232);
        _statusBadge.ForeColor = Color.FromArgb(22, 120, 68);
        _statusTitle.Text = "Protection is active";
        _statusBody.Text = "Preview mode is showing the current Windows Forms layout.";
        _anchorValue.Text = "Saved pointer anchor: X 1280  |  Y 720";
        _supportTitleLabel.Text = "Support and suggestions";
        _gratitudeLabel.Text = "Thank you for using MouseTool. This preview is safe to open in the Visual Studio designer.";
        _supportEmailLink.Text = "mvidaldev@outlook.com";
        _logStatusLabel.Text = "Logging is disabled";
        _overviewTab.Text = "Overview";
        _displaysTab.Text = "Displays";
        _behaviorTab.Text = "Behavior";
        _diagnosticsTab.Text = "Diagnostics";
        _helpButton.Text = "Open Help";
        _coffeeButton.Text = "Send a Coffee";
        _startButton.Enabled = false;
        _stopButton.Enabled = true;
        _enableLogButton.Enabled = true;
        _disableLogButton.Enabled = false;
    ...
    private void BuildOverviewTab()
    {
        ...
        {
            var supportEmail = T("OverviewSupportEmail");
        ...
        _helpButton.Text = T("HelpButton");
        ConfigureActionButton(_helpButton, T("HelpButton"), Color.White, Color.FromArgb(21, 51, 91), new Point(0, 252), 250);
        ...
        var helpHintLabel = new Label
        {
            ...
            ForeColor = Color.FromArgb(88, 100, 118),
            Text = T("OverviewHelpHint")
        };

        _coffeeButton.Text = T("CoffeeButton");
        ConfigureActionButton(_coffeeButton, T("CoffeeButton"), Color.FromArgb(255, 224, 179), Color.FromArgb(106, 63, 0), new Point(0, 362), 250);
        ...
        contentStack.Controls.Add(CreateOverviewTextCard(T("OverviewHowTitle"), T("OverviewHowBody"), Color.FromArgb(21, 83, 144), 176), 0, 1);
        contentStack.Controls.Add(CreateOverviewStepsCard(T("OverviewWorkflowTitle"), SplitLocalizedLines(T("OverviewWorkflowBody")), Color.FromArgb(28, 120, 68)), 0, 2);
        contentStack.Controls.Add(CreateOverviewStepsCard(T("OverviewTipsTitle"), SplitLocalizedLines(T("OverviewTipsBody")), Color.FromArgb(183, 111, 0)), 0, 3);
    ...
    private void BuildDisplaysTab()
    {
        ...
        var mappingTitle = CreateSectionTitle(T("DisplaysTitle"), 24, 22);
        var mappingBody = CreateSectionBody(T("DisplaysBody"), 24, 56, 900, 42);
        ...
        mappingCard.Controls.Add(CreateComboField(T("DisplaysPrimary"), _primaryMonitorComboBox, 24, 116));
        mappingCard.Controls.Add(CreateComboField(T("DisplaysTouch"), _touchMonitorComboBox, 24, 184));

        var notesCard = CreateCardPanel();
        notesCard.Dock = DockStyle.Fill;
        notesCard.Controls.Add(CreateSectionTitle(T("DisplaysTipsTitle"), 24, 22));
        notesCard.Controls.Add(CreateSectionBody(T("DisplaysTipsBody1"), 24, 56, 900, 60));
        notesCard.Controls.Add(CreateSectionBody(T("DisplaysTipsBody2"), 24, 126, 900, 60));
    ...
    private void BuildBehaviorTab()
    {
        ...
        card.Controls.Add(CreateSectionTitle(T("BehaviorTitle"), 24, 22));
        card.Controls.Add(CreateSectionBody(T("BehaviorBody"), 24, 56, 900, 42));

        _restoreImmediatelyCheckBox.Text = T("BehaviorRestoreNow");
        ...
        var helper = CreateSectionBody(T("BehaviorRestoreHelp"), 46, 150, 860, 46);
        _allowMouseOnTouchscreenCheckBox.Text = T("BehaviorAllowMouseTouchscreen");
        ...
        var allowMouseHelper = CreateSectionBody(T("BehaviorAllowMouseTouchscreenHelp"), 46, 250, 860, 46);
        _startWithWindowsCheckBox.Text = T("BehaviorStartWithWindows");
        ...
        var startupHelper = CreateSectionBody(T("BehaviorStartWithWindowsHelp"), 46, 350, 860, 46);
    ...
    private void BuildDiagnosticsTab()
    {
        ...
        card.Controls.Add(CreateSectionTitle(T("DiagnosticsTitle"), 24, 22));
        card.Controls.Add(CreateSectionBody(T("DiagnosticsBody"), 24, 56, 900, 44));

        ConfigureActionButton(_enableLogButton, T("DiagnosticsEnableLog"), Color.FromArgb(21, 83, 144), Color.White, new Point(24, 122));
        ...
        ConfigureActionButton(_disableLogButton, T("DiagnosticsDisableLog"), Color.FromArgb(232, 236, 241), Color.FromArgb(40, 51, 67), new Point(204, 122));
        ...
        ConfigureActionButton(_openLogButton, T("DiagnosticsOpenLog"), Color.White, Color.FromArgb(21, 51, 91), new Point(384, 122));
    ...
    private Control BuildFooter()
    {
        ...
        ConfigureActionButton(_startButton, T("FooterStart"), Color.FromArgb(26, 124, 72), Color.White, Point.Empty, 170);
        _startButton.Click += (_, _) => _context?.StartProtection();

        ConfigureActionButton(_stopButton, T("FooterPause"), Color.FromArgb(232, 236, 241), Color.FromArgb(40, 51, 67), Point.Empty, 170);
        _stopButton.Click += (_, _) => _context?.StopProtection();

        ConfigureActionButton(_trayButton, T("FooterTray"), Color.White, Color.FromArgb(21, 51, 91), Point.Empty, 180);
        _trayButton.Click += (_, _) => _context?.MinimizeMainFormToTray();

        ConfigureActionButton(_configButton, T("FooterConfig"), Color.White, Color.FromArgb(21, 51, 91), Point.Empty, 200);
        _configButton.Click += (_, _) => _context?.OpenConfigFolder();

        ConfigureActionButton(_applyButton, T("FooterApply"), Color.FromArgb(21, 83, 144), Color.White, Point.Empty, 180);
    ...
    {
        if (_context is not null && _languageComboBox.SelectedItem is LanguageOption language)
        {
